...
module.exports = {
    ...
    hooks: {
        finish: function () {
            var configOption = this.config.get('pluginsConfig')['theme-document'];
            ...
            if(pathFile){
                ...
                var pluginLogoPath = path.join(process.cwd(), output, 'gitbook','gitbook-plugin-theme-document',"logo.png");
